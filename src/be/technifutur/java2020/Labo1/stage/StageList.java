...
public class StageList implements List, Serializable {
    ...
    public void addPrice(String stageName, String priceName) {
        list.get(stageName).addPrice(priceName);
    }

    public void removePrice(String stageName, String priceName) {
        list.get(stageName).removePrice(priceName);
    }
